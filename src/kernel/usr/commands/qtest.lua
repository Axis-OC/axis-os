...
--
-- Loads the deliberately faulty QuarantineTester driver, triggers
-- dispatch faults to activate HVCI quarantine, then verifies the
-- driver is blocked from further operation.
--
-- Usage:  qtest           (must be root)
--
